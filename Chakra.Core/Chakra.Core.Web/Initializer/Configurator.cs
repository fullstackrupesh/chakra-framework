...
namespace Chakra.Core.Web.Initializer
{
    public class Configurator
    {
        ...
        public static void ConfigureApplication(IApplicationBuilder app, IConfiguration configuration)
        {
        ...
        public static void InitializeStartups(IServiceProvider provider, IConfiguration configuration)
        {
        ...
        private static IEnumerable<T> InstantiateAllTypes<T>() where T : class
        {
            LoadAssemblies();
